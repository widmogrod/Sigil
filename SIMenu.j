...
- (id)initWithDelegate:(id)delegate
{
	...
	// W tej wersji Cappuccino nie ma rużnicy czy wywołam SIMenu czy CPMenu i tak zadziała
	// pobieważ te popcje są traktowane jako "single"

	// ustawia tytuł na pasku menu
	// to będzie ustawiane podczas utworzenia dokumentu
	//[SIMenu setMenuBarTitle:@"Takkkk"];

	// menu widoczne
	[SIMenu setMenuBarVisible:YES];
	...
	[SIMenu setMenuBarIconImage: image];
